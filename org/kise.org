...
*** STARTED adding GPLv3 to all files in Kisê, sqlite and latex

*** STARTED adding GPLv3 to all files in 2.0 [common]

*** TODO :use-module (kise strings) must become 'common'

*** TODO (connect (reuse-db-cb kc-widget) incomplete

*** TODO need to catch latex compilition errors !!

*** TODO adding us and a4papar to the printing options
...
*** TODO programming the preferences dialog
...
*** TODO we need to cach combo values [slow db]
...
*** TODO adding preferences button and dialog
...
[may have] DPI settings [mine is 76, christian's is 96]. This would
...
*** TODO display the name of the database
...
** TODO db-kise/fields-offsets: extending with tex table info
...
** TODO gtkrc.kise, glade and text files locations hard coded
